...
const { TypeNames, isBuiltinType } = require('./builtin-types');
...
const TYPES = {
  ...
  [TypeNames.FLOAT]: {
    ...
    coerce: {
      ...
      [TypeNames.INT]: value => Math.round(value),
    },
  },
  ...
  [TypeNames.FUNC]: {
    ...
    print: /* istanbul ignore next */ () => [TypeNames.FUNC],
...
const resolveTypedef = (typedef, userTypedefs = null) => {
  if (TypeNames[typedef.type]) return typedef;
